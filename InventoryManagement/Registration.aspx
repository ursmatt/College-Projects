...
<%@ Page Title="Supplier" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Registration.aspx.cs" Inherits="Registration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="auto-style42">
        ...
        <tr>
            <td class="auto-style43" colspan="2">Department:</td>
            <td class="auto-style44" colspan="2">
        ...
        <asp:GridView ID="supplierGrid" runat="server" AutoGenerateColumns="false" HorizontalAlign="Center" >
            <columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkView" runat="server" CommandArgument='<%# Eval("SupplierId") %>'>Select</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </columns>
        </asp:GridView>
