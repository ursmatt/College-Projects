...

{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //TextBox2.ReadOnly = txtQuantity1.ReadOnly = txtQuantity2.ReadOnly = true;
    ...
    //{
    //    TextBox2.ReadOnly = txtQuantity1.ReadOnly = txtQuantity2.ReadOnly = true;
    //    TextBox2.Text = TextBox2.Text = txtQuantity1.Text = txtQuantity2.Text = "";
    //    btnsell.Enabled = false;
    //}
    ...
    {
        sqlcon.Open();
        SqlCommand com = new SqlCommand("insert into Qutation values('" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + txtQuantity1.Text + "','" + txtQuantity2.Text + "','" + txtQuantity3.Text + "','0')", sqlcon);
        com.ExecuteNonQuery();
        ...
        //if (sqlcon.State == ConnectionState.Closed)
        //    sqlcon.Open();
        //String updateQuery = "Update Purchase set Purchase.Quantity = Purchase.Quantity -'" + txtQuantity2.Text + "' from Product inner join Purchase on Product.ProductId = Purchase.ProductId inner join Supplier on Purchase.SupplierId = Supplier.SupplierId Where Product.ProductName = '" + TextBox2.Text + "' and Supplier.CompanyName = '" + TextBox2.Text + "'";
